...
To register for Copilot Pro, log in with your USMA credentials. First, disconnect your email if it’s already linked to an account. Go to https://github.com/login and sign in using your USMA credentials. Then, navigate to the emails tab in your personal account (personal account -> access -> emails) and click 'unverify' for your westpoint.edu email. Next, log out, then log back in with your personal account, and attach your westpoint.edu email to the account. Finally, verify your student status by visiting https://github.com/education/students, clicking 'Join GitHub Education,” and submitting proof of your student status (like a transcript screenshot). It can take up to 72 hours for the verification to complete, after which you should be ready to use it. % provide instructions for registering for Copilot Pro using a student license
...
I think that TinkerCAD is a very useful resource for this course. TinkerCAD is helpful because it provides an additional way to verify your work. On TinkerCAD, you can model most of the components that go along with the BOE-Bot, which is frequently used throughout the course. I found myself using it as a way to sketch out my wiring for my robot and to test my code when I needed extra time. Sometimes this can be helpful because certain components can be faulty and might mislead you about where the problem really is. TinkerCAD can also be useful when creating block diagrams for your Arduino Uno.

\subsection{Advice from CDT Keishun Pickett}
One important component for this course is ensuring that you include the libraries in your functions when you run your code. Some libraries are available directly in the Visual Studio Code toolbar, while others must be downloaded from external sources. For those available directly in Visual Studio Code, go to the PlatformIO icon on the left side, then navigate to Quick Access -> PIO Home -> Libraries. From there, search for the specific library you need (e.g., Servo, Arduino). Click on the library, then select 'Add to Project.' Here, you should be able to choose the project you want to add the library to, provided you've already created the project. After that, go to the main coding area within that project and call the library in your code (e.g., #include <Arduino.h>). For libraries not readily available in the Visual Studio Code, you'll need to download the suggested library from the project instructions. Click the <Code> button in the top-right corner to download the ZIP file. After downloading, unzip the file and open the primary folder. Then, you can drag and drop the ColorPal folder into the library section of a project in Visual Studio Code. From there you should be able to call for the library(e.g. #include ColorPAL.h>).
