...
At the start of each project, start with a simple outline of the SDA framework. Typically, I would sugguest looking at your block
diagram and state diagram to identify what sensors your are using- this is how you know what you are "sensing". Your states from your
...
The Sense-Decide-Act framework is a great way to structure your prompts to AI. So, when you begin writting your code, ensure that you 
...
Additionally, generative AI was helpful for group projects. For project 4, my partners and I each coded a seperate section or state. By the time we each had the
...
one project. However, it is critical that you understand the components of the code that you are using so that you can effectively debugg your
project. 
...
I have found that Arduino IDE and the libraries we import throughout this class have many tester files. I reccomend that when you
...
a lot of time if I had used these exampled files earlier in the course. The examples will give you a basic set up for servo controlled
...
file in Arduino IDE or in a testcode file. I have found that sometimes problems are easier to debugg when you isolate the function/ state that
the problem is occuring in. Lastly, I highly highly recommend using serial prints throughout your code to debugg, especially when you are using
...
For example, when you integrate a state, just simply write "serial.print(in state x") or use an LED and write "digitalWrite(LED_X, HIGH") so you can
